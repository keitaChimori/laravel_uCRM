            ...
            <section class="text-gray-600 body-font">
              <div class="container px-5 py-8 mx-auto">
                ...
                <div class="flex pl-4 my-4 lg:w-2/3 w-full mx-auto">
                  <div>
                    <input type="text" name="search" v-model="search" class="shadow rounded" placeholder="フリガナで検索">
                    <button @click="searchCustomers" class="bg-indigo-500 text-white py-2 px-4 ml-2 rounded focus:outline-none hover:bg-indigo-600">検索</button>
                  </div>
                  ...
                  <table class="table-auto w-full text-left whitespace-no-wrap">
                    ...
                    <tbody>
                      <tr v-for="customer in customers.data" :key="customer.id">
                        ...
                        <td class="px-4 py-3 border-b-2 border-gray-200 text-blue-600">{{ customer.name }}</td>
              ...
              <Pagination :links="customers.links" class="mt-4"></Pagination>
            </section>
          </div>
        </div>
      </div>
